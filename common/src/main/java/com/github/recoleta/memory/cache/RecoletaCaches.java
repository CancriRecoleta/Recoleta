...
public final class RecoletaCaches {
    ...
    /**
     * Cache for {@link PlainTextContents.LiteralContents} instances keyed by their text.
     *
     ...
     */
    public static final SoftLruCache<String, PlainTextContents.LiteralContents> LITERAL_CONTENTS =
