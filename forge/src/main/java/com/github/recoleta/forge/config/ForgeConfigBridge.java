package com.github.recoleta.forge.config;
...
/**
 * Forge-side config spec. Pushes values into the loader-agnostic
 * {@link MemoryConfig} holder on every load / reload.
 */
public final class ForgeConfigBridge {
    ...
    private static final BooleanValue ENABLE_CAPABILITY_FAST_COMPARE;
    ...
    static {
        ...
        ENABLE_CAPABILITY_FAST_COMPARE = b
                .comment("Compare CapabilityDispatcher writers entry-by-entry to avoid",
                        "building two full CompoundTag snapshots on every ItemStack equality check.")
    ...
    public static void onConfigLoad(final ModConfigEvent event) {
        ...
        MemoryConfig.enableCapabilityFastCompare = ENABLE_CAPABILITY_FAST_COMPARE.get();
